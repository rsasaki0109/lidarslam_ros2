...
# v15 container candidate: callback transport and terminal support context are
...
EXPECTED_PROFILE_PATH='configs/slam_benchmark_profiles/fast_livo2_m6a10_v15_formal_ready.yaml'
...
fail() { echo "FAST-LIVO2 v15 formal container gate failed: $*" >&2; return 1; }
OUT_DIR="${OUT_DIR:-/out}"
